...
if (!function_exists('icon')) {
  function icon(string $icon, string $color = "#000000"): string
  {
    switch ($icon) {
      case "show":
        echo <<<EOD
